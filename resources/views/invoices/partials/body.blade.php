...
<div class="card mx-auto max-w-3xl p-8 print:shadow-none">
    ...
    @if ($transaction->description || $transaction->reference)
        <div class="mt-6 rounded-xl bg-slate-50 p-4 text-sm dark:bg-slate-800">
    ...
    <div class="mt-8 flex items-end justify-between border-t border-slate-200 pt-6 dark:border-slate-800">
        <div class="text-sm text-slate-500">Amount due</div>
